...
public:
    ...
    formGeriAl() {
        ...
        TvUyeler->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
        TvGetirilmeyenler->addAction(actionGetirdi);
        TvGetirilenler->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
        TvGetirilmeyenler->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
